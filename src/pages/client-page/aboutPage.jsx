...
export default function AboutPage() {
  ...
  <>
    ...
    {/* About Section */}
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16 text-gray-700">
      <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8">Welcome to Leonine Villa</h2>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
        <img
          ...
          alt="Interior"
          className="w-full h-64 sm:h-80 md:h-64 object-cover rounded-lg shadow"
        />

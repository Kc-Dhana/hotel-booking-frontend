...
export default function RejectedRequests() {
  ...
  useEffect(() => {
    ...
    axios
      .get(import.meta.env.VITE_BACKEND_URL + "/api/bookings/customer-bookings?status=rejected", {
        headers: {
 ...
 return (
  <div className="p-6 sm:p-8 bg-gray-100 min-h-screen">
    <h1 className="text-3xl font-bold text-gray-800 mb-6">Rejected Booking Requests</h1>
      ...
      {bookings.map((booking) => (
        <div key={booking.bookingId} className="bg-white p-4 shadow rounded-lg border border-gray-200">
          ...
          <p>
            ...
            <span className="capitalize text-red-600 font-semibold">{booking.status}</span>
          </p>
